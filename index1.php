...
$connection=new PDO("mysql:host=localhost;dbname=monumentdb;charset=utf8","root","mysql");
...
// $query="INSERT INTO MONUMENTS(size,monument_type,person_number) VALUE('кастомный большой','гранитный','на одного')";
$query="DELETE FROM monuments WHERE id__monument=23";
